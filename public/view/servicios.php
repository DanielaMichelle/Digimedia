...
<body>
    ...
    <!-- <div class="con-anun3">
        <div class="parrafos1">
            <h5 class="titulo1" style="text-shadow:rgba(0, 0, 0, 0.4) 0px 4px 5px;"><Big><Big>¿Quieres iniciarte en el
                        mundo digital?</Big></Big></h5>
            <div class="pt-3"></div>
            <p style="font-size:20px; line-height:normal;"><b>En DIGIMEDIA te ayudamos a emprender o hacer crecer tu
                    negocio.</b></p>
        </div>
        <div class="pt-3"></div>
        <div class="bota1">
            <a href="contacto.php" title="¡Contactanos!" class="boton__2"
                style="box-shadow:2px 3px 2px black ">Contactar</a>
        </div>
        <div class="pt-5"></div>
    </div> -->
